// Source: https://github.com/Aylur/ags/files/12555193/ags.txt
...
declare module 'resource:///com/github/Aylur/ags/service/systemtray.js' {
  export type Category = 'ApplicationStatus' | 'Communications' | 'SystemServices' | 'Hardware';
  export type Status = 'Passive' | 'Active' | 'NeedsAttention';

  export interface TrayItem {
    menu: object | undefined; // TODO object -> Gtk.Menu 
    category: Category;
    id: string;
    title: string;
    status: Status;
    // `window-id`: number; TODO
    // is-menu: boolean; TODO
    // tooltip-markup: string; TODO
    icon: string | object; // TODO object -> GdkPixbuf.Pixbuf

    // TODO Event, EventScroll
    activate(event: object): void;
    secondaryActivate(event: object): void;
    scrool(event: object): void; // EventScroll
    openMenu(event: object): void;
  }

  interface SystemTray extends Service {
    items: TrayItem[];
